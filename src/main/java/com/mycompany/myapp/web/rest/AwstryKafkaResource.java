...
@RestController
@RequestMapping("/api/awstry-kafka")
public class AwstryKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AwstryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AwstryKafkaResource(KafkaProperties kafkaProperties) {
